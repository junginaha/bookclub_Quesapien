...
const STARTER_QUESTIONS: Record<string, string[]> = {
  ...
  "arthur-schopenhauer": [
    "욕망을 줄이는 것이 진정한 행복으로 가는 길인가?",
    "고통 없이 살 수 있다면 삶은 더 의미 있을까?",
    "예술이 고통으로부터 우리를 해방시킬 수 있는가?",
  ],
  "georg-hegel": [
    "역사는 진보하는가?",
    "개인의 자유와 사회의 질서는 어떻게 조화를 이루는가?",
    "모순은 어떻게 극복되는가?",
  ],
  "socrates": [
    "나는 지금 내가 모른다는 것을 알고 있는가?",
    "검토되지 않은 삶을 살고 있지는 않은가?",
    "진정한 지혜란 무엇인가?",
  ],
  "fyodor-dostoevsky": [
    "자유는 인간에게 축복인가, 형벌인가?",
  ...
  "leo-tolstoy": [
    "삶의 의미는 무엇인가?",
    "죽음 앞에서 우리는 어떻게 살아야 하는가?",
    "도덕적 삶이란 어떤 삶인가?",
  ],
  "franz-kafka": [
    "나는 스스로 만든 감옥 안에 있지는 않은가?",
    "부조리한 세계에서 인간은 어떻게 의미를 찾는가?",
    "규칙과 관료제 앞에서 인간은 무엇을 잃는가?",
  ],
  "virginia-woolf": [
    "나만의 방과 시간을 갖고 있는가?",
    "창의적 삶을 위해 무엇이 필요한가?",
  ...
  "albert-einstein": [
    "상상력과 지식 중 무엇이 더 중요한가?",
    "과학과 인문학은 어떻게 연결되는가?",
    "단순함 속에서 위대함을 발견할 수 있는가?",
  ],
  "leo-da-vinci": [
    "예술과 과학을 동시에 탐구할 수 있는가?",
    "끝없는 호기심이 삶을 어떻게 바꾸는가?",
    "관찰이 창의성의 시작인가?",
  ],
  "marcus-aurelius": [
    "내가 통제할 수 없는 것에 시간을 낭비하고 있지는 않은가?",
    "권력 앞에서 어떻게 덕을 지킬 수 있는가?",
    "지금 이 순간 최선을 다하고 있는가?",
  ],
  default: [
    "이 질문에 어떻게 답하시겠습니까?",
